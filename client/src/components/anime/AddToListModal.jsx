    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <h2 className="text-h4 md:text-h3 font-bold text-white mb-6 text-center tracking-tight">Add to Custom List</h2>
          ...
          <div className="mb-8 space-y-2 max-h-48 overflow-y-auto custom-scrollbar pr-2">
            ...
            {customLists.length === 0 && (
              <p className="text-white/50 text-micro text-center py-4">You don't have any custom lists yet.</p>
            )}
          </div>
          ...
          <div className="space-y-4">
            <div className="relative">
              <label className="text-[11px] font-bold text-white/50 uppercase tracking-widest absolute -top-2 left-0">Create New List</label>
              <input
                type="text"
                value={newListName}
                ...
                className="w-full bg-transparent border-b border-primary/50 text-white p-2 pt-4 outline-none focus:border-primary transition-colors text-body font-medium placeholder:text-white/20"
