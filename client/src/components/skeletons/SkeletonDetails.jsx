...
const SkeletonDetails = () => {
 ...
 <div className="relative w-full px-4 md:px-16 pt-64 pb-24 md:pb-32 z-10">
 <div className="max-w-4xl">
 <div className="h-3 w-32 bg-primary/10 mb-4 block" />
 <div className="h-12 md:h-[60px] w-3/4 bg-neutral-800 mb-8" />
 ...
 <div className="h-3 w-12 bg-neutral-900" />
 ...
 <div className="h-10 w-full sm:w-32 bg-neutral-900" />
 </div>
