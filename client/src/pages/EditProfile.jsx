...
const EditProfile = () => {
 ...
 <div className="w-28 h-28 md:w-32 md:h-32 rounded-xl overflow-hidden group-hover: transition-all">
 <SafeImage src={avatarUrl} alt="Selected Avatar" className="w-full h-full object-cover" />
 <div className="absolute inset-0 bg-white/5 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="fixed inset-0 z-[200] bg-neutral-900/80 backdrop-blur-3xl flex flex-col p-4 md:p-12 overflow-y-auto"
 >
 ...
 className="relative aspect-square bg-white/5 backdrop-blur-md rounded-xl border border-white/10 overflow-hidden rounded-xl cursor-pointer group hover: transition-all"
 >
