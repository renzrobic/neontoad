    ...
    <div className="min-h-screen bg-transparent flex flex-col items-center justify-center text-center px-4">
      ...
      <div className="py-24 px-4 flex flex-col md:flex-row items-center justify-center gap-12 max-w-4xl w-full">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left gap-4">
          <h1 className="text-[120px] md:text-[150px] font-black text-white/5 leading-none absolute -z-10 tracking-tighter left-1/2 md:left-auto md:right-10 top-1/2 -translate-y-1/2 -translate-x-1/2 md:translate-x-0">404</h1>
          <h2 className="text-h3 md:text-h2 font-bold text-white/90 tracking-tight">Are you lost?</h2>
          <p className="text-micro md:text-[15px] font-normal text-white/50 max-w-sm leading-relaxed tracking-tight mb-4">
            The page you are looking for doesn't exist or has been moved. Let's get you back to the anime.
          </p>
          <Link
            to="/"
            className="bg-primary text-black px-10 py-4 rounded-full font-bold text-micro flex items-center gap-3 hover:scale-105 active:scale-95 transition-all shadow-xl tracking-tight"
          >
