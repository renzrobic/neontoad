            ...
            : (
              <div className="h-[100dvh] w-full flex flex-col items-center justify-center text-white/90 gap-6 px-6 text-center">
                ...
                <button onClick={() => setShowUpload(true)}
                  className="bg-primary text-background px-10 py-4 font-bold text-micro hover:bg-primary/90 transition-all shadow-xl shadow-primary/20 tracking-wide rounded-full">
