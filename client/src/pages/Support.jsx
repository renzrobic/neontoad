...
const Support = ({ title, content }) => {
 ...
 >
 <h1 className="text-h2 md:text-h1 font-medium text-white mb-8">{title}</h1>
 <div className="prose prose-invert max-w-none">
 <p className="text-white text-h4 leading-relaxed mb-6 font-medium">
 Last Updated: May 10, 2026
 </p>
 <div className="space-y-8 text-white leading-loose">
 <section>
 <h2 className="text-h3 font-medium text-white mb-4">1. Overview</h2>
 ...
 <section>
 <h2 className="text-h3 font-medium text-white mb-4">2. Key Points</h2>
 <p className="font-medium">
 ...
 <section>
 <h2 className="text-h3 font-medium text-white mb-4">3. Contact Us</h2>
 <p className="font-medium">
